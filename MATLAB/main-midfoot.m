...
fid = fopen(strcat('C:\Users\NM\Documents\GitHub\Running-Form\data\',runNumber,'\normal-midfoot\full\',runNumber,'-normal-midfoot-gps.txt'));
display(fid);
...
rollAnglePlusMinus = 4; % 2 degrees of +/- error for now.
